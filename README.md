...
The current versions of these scripts assume you are using `v0.3.0` of the Code Analysis docker images. There are some command line option, behavior, and output differences between the released versions for the docker images.
...
```shell
docker pull leadingagilestudios.azurecr.io/analysis/gather:0.3.0
docker pull leadingagilestudios.azurecr.io/analysis/gather-cli:0.3.0
```
...
Requires the `leadingagilestudios.azurecr.io/analysis/gather-cli:0.3.0` image.
...
Options:
 ...
 -i, --image
      ...
      Defaults to 'leadingagilestudios.azurecr.io/analysis/gather-cli:0.3.0'
...
Options:
 ...
 -i, --image
      The docker image to use.
      Defaults to 'leadingagilestudios.azurecr.io/analysis/gather:0.3.0'
